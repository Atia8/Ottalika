...
//           ✅ SUCCESS: OwnerDashboard is working!
//         </h1>
//         <p className="text-gray-600">
//           Check browser console - you should see "✅ OwnerDashboard component loaded!"
//         </p>
//         <div className="mt-4 p-4 bg-green-100 border border-green-400 rounded">
//           <p>If you see this text and the navbar on the left, your routing is working!</p>
//         </div>
//       </main>
//     </div>
//   );
